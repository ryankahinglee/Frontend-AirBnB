...
describe('ImageDeleteButton', () => {
  it('renders ImageDeleteButton component', () => {
  ...
  it('svg triggers the onclick function', () => {
    ...
    const wrapper = shallow(<ImageDeleteButton images={['nice', 'five', 'big']} imagesSetter={mockFn} img={'nice'}/>);
    const svg = wrapper.find('svg');
    svg.simulate('click');
  ...
  it('svg causes an image delete on click', () => {
    ...
    const wrapper = shallow(<ImageDeleteButton images={images} imagesSetter={mockFn} img={'nice'}/>);
    const svg = wrapper.find('svg');
    svg.simulate('click');
